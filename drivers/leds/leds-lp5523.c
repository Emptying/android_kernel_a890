...
#endif
//add by benjaminwan 2015.05.17
		if(strncmp(buf, "mode", 4)==0)
		{
			if(buf[4] >= '0'){
				i = buf[4] - '1';
				printk("LED Mode Num -> %d \n",i);
				mutex_lock(&pan_led->lock);
				switch (i) {
				case 0://red
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 6,255);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 7,255);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 0,0);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 2,0);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 1,0);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 3,0);
					break;
				case 1://green
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 6,0);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 7,0);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 0,255);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 2,255);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 1,0);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 3,0);			
					break;
				case 2://yellow
				...
				case 3://blue
					...
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 0,0);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 2,0);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 1,255);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 3,255);
					break;
				case 4://purple
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 6,160);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 7,160);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 0,32);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 2,32);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 1,255);
					lp5523_write(pan_led->client, LP5523_REG_LED_PWM_BASE + 3,255);
					break;
				case 5://cyan
